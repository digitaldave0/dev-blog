---
title: >-
  AWS Solutions Architect Associate: Domain 5 - Define Operationally Excellent
  Architectures
description: >-
  Complete guide to Domain 5: designing operationally excellent architectures
  using infrastructure as code, monitoring, automation, and best practices.
tags:
  - aws
  - certification
  - architect
...
heroImage: 'https://picsum.photos/seed/2025-11-05-aws-domain-5/800/400'
---
...
Resources:
  ...
  WebServer:
    ...
    Properties:
      ImageId: !Sub "{% raw %}{{resolve:ssm:/aws/service/ami-amazon-linux-latest/amzn2-ami-hvm-x86_64-gp2}}{% endraw %}"
